                ...
                <div>
                    ...
                    <div className="flex lg:gap-4 gap-3 mt-2">
                        <button
                            ...
                            className={`px-2 lg:px-4 py-2  text-white rounded-lg transition-all duration-300 ${activeIndex === 1 ? "bg-blue-800" : "hover:bg-[#352896] hover:text-[103%] bg-[#120b54]"}`}
                        >
                            &#8377;10
                        </button>
                        <button
                            ...
                            className={`px-2 lg:px-4 py-2 text-white rounded-lg transition-all duration-300  ${activeIndex === 2 ? "bg-blue-800" : "hover:bg-[#352896] hover:text-[103%] bg-[#120b54]"}`}
                        >
                            &#8377;20
                        </button>
                        <button
                            ...
                            className={`px-2 lg:px-4 py-2 text-white rounded-lg transition-all duration-300  ${activeIndex === 3 ? "bg-blue-800" : "hover:bg-[#352896] hover:text-[103%] bg-[#120b54]"}`}
                        >
                            &#8377;50
                        </button>
                        <input
